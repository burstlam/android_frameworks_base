...
//            mHandler.sendEmptyMessage(MSG_HIDE_INTRUDER);
    ...
    private Bitmap createRoundIcon(StatusBarNotification notification) {
        ...
        if (notification.etNotification().largeIcon != null
            ...
            Bitmap scaledBitmap = Bitmap.createScaledBitmap(notification.etNotification().largeIcon, newWidth, newHeight, true);
