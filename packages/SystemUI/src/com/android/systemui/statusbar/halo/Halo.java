...
public class Halo extends FrameLayout implements Ticker.TickerCallback, TabletTicker.TabletTickerCallback {
    ...
    public Halo(Context context, AttributeSet attrs, int defStyle) {
        ...
        // Init variables
        mInteractionReversed = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.HALO_REVERSED, 1) == 1;
        mHideTicker = Settings.System.getInt(mContext.getContentResolver(), 
    ...
    class HaloEffect extends HaloProperties {
        ...
        public HaloEffect(Context context) {
            ...
            if (mHaloSize != 1.0f) {
                ...
                mMarkerL = Bitmap.createScaledBitmap(mMarkerL, (int)(mMarkerL.getWidth() * mHaloSize),
                        (int)(mMarkerL.getHeight() * mHaloSize), true);
                mMarkerT = Bitmap.createScaledBitmap(mMarkerT, (int)(mMarkerT.getWidth() * mHaloSize),
                        (int)(mMarkerT.getHeight() * mHaloSize), true);
                mMarkerR = Bitmap.createScaledBitmap(mMarkerR, (int)(mMarkerR.getWidth() * mHaloSize),
                        (int)(mMarkerR.getHeight() * mHaloSize), true);
