...
public class QuickSettings {
   ...
   // private static final int BT_TETHER_TILE = 32;
    ...
    private static final int PROFILE_TILE = 28;
    private static final int STATUSBAR_TILE = 29;
    private static final int QUIETHOURS_TILE = 30;
